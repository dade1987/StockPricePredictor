...
if (modalita === 7) {
  ...
  // ai secondi 20 così almeno fa ora a valutare i volumi e prezzi dell'inizio della candela corrente (in 1 min)
  nextMinuteDate = roundUpTo2Minutes(new Date()) + (1000 * 20)
