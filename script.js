...
//QOUA4VUTZJXS3M01
    ...
    return new Promise((resolve, reject) => {
        ...
        const url = 'https://www.alphavantage.co/query?function=FX_DAILY&from_symbol=EUR&to_symbol=USD&outputsize=full&apikey=QOUA4VUTZJXS3M01';

        //const url = 'https://www.alphavantage.co/query?function=FX_DAILY&from_symbol=GBP&to_symbol=JPY&outputsize=full&apikey=QOUA4VUTZJXS3M01';
        ...
        $.getJSON(url, function (data) {
            ...
            let rawData = Object.values(data["Time Series FX (Daily)"]).map(d => ({open: parseFloat(d["1. open"]), high: parseFloat(d["2. high"]), low: parseFloat(d["3. low"]), close: parseFloat(d["4. close"])}));
